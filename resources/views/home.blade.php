...
@section('content')
        ...
        <div class="relative container-site">
            <div class="text-center max-w-2xl mx-auto reveal">
                ...
                <p class="mt-6 text-ivory/75 leading-relaxed">
                    A student development framework no other school in Egypt offers — four pillars working together to
                    shape confident, responsible, innovative, reflective and engaged learners.
                </p>
            </div>
            ...
            <div class="mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @php
                    $pillars = [
                        ['title' => 'Academic Excellence', 'desc' => 'A rigorous British curriculum delivered by exceptional teachers, with the highest standards in learning and achievement.', 'icon' => 'M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5'],
                        ['title' => 'Cambridge Learner Attributes', 'desc' => 'Nurturing learners who are confident, responsible, innovative, reflective and engaged — in class and in life.', 'icon' => 'M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z'],
                        ['title' => 'UN Global Goals', 'desc' => 'Part of the UN Global Schools Program — all 17 Sustainable Development Goals woven into everyday learning.', 'icon' => 'M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418'],
                        ['title' => 'Digital Learning', 'desc' => 'Technology integrated across the curriculum — and a fully cashless smart campus that parents manage from their phones.', 'icon' => 'M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25'],
                    ];
                @endphp
    ...
    <section id="book-tour" class="py-20 sm:py-28 bg-maroon-950 text-ivory relative overflow-hidden">
        ...
        <div class="relative container-site grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div class="reveal">
                <form class="bg-ivory text-charcoal-800 rounded-sm shadow-2xl p-7 sm:p-9" method="POST" action="#">
                    ...
                    <div class="mt-7 space-y-5">
                        <div>
                            ...
                            <input type="text" id="parent_name" name="parent_name" required autocomplete="name"
                        ...
                        <div>
                            ...
                            <input type="tel" id="phone" name="phone" required autocomplete="tel" inputmode="tel" placeholder="01XXXXXXXXX"
                                   class="w-full h-12 px-4 rounded-sm border border-beige-300 bg-white focus:border-gold-600 focus:ring-2 focus:ring-gold-500/30 focus:outline-none transition-colors">
                        </div>
