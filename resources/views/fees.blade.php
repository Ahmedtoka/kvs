...
<section class="py-20 sm:py-24 bg-ivory">
    <div class="container-site grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div class="reveal">
            <form class="bg-maroon-950 text-ivory rounded-sm shadow-xl p-7 sm:p-10" method="POST" action="#">
                ...
                <div class="mt-8 space-y-5">
                    <div>
                        ...
                        <input type="text" id="f_name" name="parent_name" required autocomplete="name" class="w-full h-12 px-4 rounded-sm border border-maroon-700 bg-maroon-900 text-ivory placeholder:text-ivory/40 focus:border-gold-500 focus:ring-2 focus:ring-gold-500/30 focus:outline-none transition-colors">
                    </div>
                    <div>
