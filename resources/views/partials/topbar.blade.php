<div class="hidden sm:block bg-maroon-950 text-ivory/90 text-[13px]">
    <div class="container-site flex items-center justify-between py-2">
        <div class="flex items-center gap-6">
            <a href="tel:+201277771119" class="flex items-center gap-2 hover:text-gold-300 transition-colors">
                ...
                Admissions: 0127 777 1119
            </a>
            <a href="mailto:admission@kvs.edu.eg" class="flex items-center gap-2 hover:text-gold-300 transition-colors">
                <svg class="w-3.5 h-3.5 text-gold-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
                admission@kvs.edu.eg
            </a>
